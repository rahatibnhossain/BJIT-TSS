    ...
    return (
        ...
        <Box pt={7} pb={2}>
            <Grid container spacing={2} justifyContent="center">
                ...
                <FormContainer>
                    <FormTitle variant="h2">{formHeader}</FormTitle>
