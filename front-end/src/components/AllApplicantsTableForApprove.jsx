...
const AllApplicantsTableForApprove = ({ applicants, showAction, setApplicants, action, actionText }) => {
                ...
                <ResponsiveTable stickyHeader>
                    <TableHead>
                        <TableRow>
                            ...
                            <StyledTableCell>
                                <TableSortLabel
                                    active={sortField === 'educationalInstitute'}
                                    direction={sortField === 'educationalInstitute' ? sortOrder : 'asc'}
                                    onClick={() => handleSort('educationalInstitute')}
                                >
